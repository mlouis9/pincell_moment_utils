...
def main():
    ...
    parser.add_argument("mode", type=str, help="Whether to generate sample files or data. Must be either 'samples' or 'data'.")
    ...
    if args.mode == 'samples':
        ...
        raise ValueError("Invalid argument. Must be either 'samples' or 'data'.")
